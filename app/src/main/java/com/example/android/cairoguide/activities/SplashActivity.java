...
/**
 * This activity class displays the first startup screen which appears when the Cairo Guide App is opened.
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //the MainActivity where the user can navigate between different sections of the app.
